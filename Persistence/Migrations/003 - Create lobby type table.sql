create table Reference.LobbyType(
    Id int not null,
    Name nvarchar(255) not null,
    Balanced bit null,
    constraint PK_Reference_LobbyType primary key (Id)
)
go

insert into Reference.LobbyType(Id, Name, Balanced)
...
insert into Reference.LobbyType(Id, Name)
