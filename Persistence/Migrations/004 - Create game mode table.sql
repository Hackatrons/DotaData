create table Reference.GameMode(
    Id int not null,
    Name nvarchar(255) not null,
    Balanced bit null,
    constraint PK_Reference_GameMode primary key (Id)
)
go

insert into Reference.GameMode(Id, Name, Balanced)
...
insert into Reference.GameMode(Id, Name)
